...
product_name = 'The Flask Mega-Tutorial'
product_price = 3900  # Price in cents

@app.route('/')
def index():
    return render_template('index.html', product_name=product_name, product_price=product_price)
